...
typedef enum CGroupMask {
        ...
        CGROUP_MASK_DEV = CGROUP_CONTROLLER_TO_MASK(CGROUP_CONTROLLER_DEV),
        ...
        CGROUP_MASK_V2 = CGROUP_MASK_CPU|CGROUP_MASK_CPUSET|CGROUP_MASK_IO|CGROUP_MASK_MEMORY|CGROUP_MASK_PIDS|CGROUP_MASK_DEV,
